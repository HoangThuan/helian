...
export default {
  ...
  computed: {
    ...
    getLanguageIcon() {
        this.flag = i18n.global.locale;
        console.log("chay vao day khong "+ this.flag);
        if(this.flag == "vi"){
          return require("@/assets/images/flags/vn.svg");
        }
        else if (this.flag == "en"){
          return require("@/assets/images/flags/us.svg");
        }
        else{
          return require("@/assets/images/flags/china.svg");
        }
    },
  },
  mounted() {
...
<template>
  <header id="page-topbar">
    <div class="layout-width">
      <div class="navbar-header">
        ...
        <div class="d-flex align-items-center gap-2 fs-6">
          <div class="d-none d-md-flex align-items-center gap-2">
            <div>
              <a class="mx-2 item-nav-font-size" href="/merchant/withdrawn-list"
                >{{ $t("提现") }}:</a
              >
              <span class="badge bg-danger-subtle text-danger" style="font-size: 14px;">{{
                withdraw
              }}</span>
            </div>
            <div>
              <a class="mx-2 item-nav-font-size" href="/payment/pay-for-order"
                >{{ $t("代付") }}:</a
              >
              <span class="badge bg-danger-subtle text-danger" style="font-size: 14px;">{{
                PaymentOnBehalf
            ...
            <div>
              <a class="mx-2 item-nav-font-size" href="/merchant/drop-order-list"
                >{{ $t("掉单") }}:</a
              >
              <span class="badge bg-danger-subtle text-danger" style="font-size: 14px;">{{
                dropOrder
            ...
            <div>
              <a class="mx-2 item-nav-font-size" href="/financial/unknown-income"
                >{{ $t("不明收入") }}:</a
              >
              <span class="badge bg-danger-subtle text-danger" style="font-size: 14px;">{{
                unknowIncome
          ...
          <BDropdown
            class="dropdown d-md-none topbar-head-dropdown header-item shadow-none"
            variant="ghost-secondary"
            dropstart
            :offset="{ alignmentAxis: 55, crossAxis: 15, mainAxis: 0 }"
            toggle-class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle show shadow-none arrow-none"
          ...
          <BDropdown
            ...
            toggle-class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none arrow-none"
          ...
          <div class="item-nav-font-size">VPN软件下载</div>

          <div class="item-nav-font-size">清空通知</div>
      ...
      <div
        class="d-flex d-md-none w-100 justify-content-center align-items-center pb-2 pt-1 gap-2"
      >
        <div>
          <a class="mx-2" href="/merchant/withdrawn-list">{{ $t("提现") }}:</a>
          <span class="badge bg-danger-subtle text-danger">{{ withdraw }}</span>
        </div>
        <div>
          <a class="mx-2" href="/payment/pay-for-order">{{ $t("代付") }}:</a>
          <span class="badge bg-danger-subtle text-danger">{{
            PaymentOnBehalf
          }}</span>
        </div>
        <div>
          <a class="mx-2" href="/merchant/drop-order-list">{{ $t("掉单") }}:</a>
          <span class="badge bg-danger-subtle text-danger">{{
            dropOrder
          }}</span>
        </div>
        <div>
          <a class="mx-2" href="/financial/unknown-income"
            >{{ $t("不明收入") }}:</a
          >
          <span class="badge bg-danger-subtle text-danger">{{
            unknowIncome
...
const PaymentOnBehalf = ref(0);
const dropOrder = ref(0);
const unknowIncome = ref(0);
</script>