          ...
          <BCardBody>
            <div class="mt-2 p-3">
              <form class="d-flex flex-row flex-wrap align-items-center gap-2">
                ...
                <div>
                  <input type="text" class="form-control" id="placeholderInput" :placeholder="$t('订单号')" style="font-size: 14px;"/>
                </div>
                <div>
                  <input type="text" class="form-control" id="placeholderInput" :placeholder="$t('商户订单号')" style="font-size: 14px;"/>
                </div>
                <div>
                  <input type="text" class="form-control" id="placeholderInput" :placeholder="$t('商户名称')" style="font-size: 14px;"/>
                </div>
                <div>
                  <input type="text" class="form-control" id="placeholderInput" :placeholder="$t('收款卡号')" style="font-size: 14px;"/>
                </div>
                <div>
