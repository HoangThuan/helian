      ...
      <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
          ...
          <router-link to="/" class="logo logo-dark">
            <span class="logo-sm">
                        <img src="https://pay2world.me/static/common/images/logo-50t9.png" alt="" height="22"
                            width="22" />
                    </span>

                    <span class="logo-lg">
                        <img src="https://pay2world.me/static/common/images/logo-50t9.png" alt="" height="35"
                            width="35" />
                        <span class="logo-text"> 马世界付 </span>
                    </span>
          </router-link>
          <!-- Light Logo-->
